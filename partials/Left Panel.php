    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="images/logo.png" alt="E-house Rental"></a>
                <a class="navbar-brand hidden"><img src="images/logo2.png" alt="E-house Rental"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="admin_home"><i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
